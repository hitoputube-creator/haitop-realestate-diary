...
function CustomerDetail({ customer, onEdit }) {
  if (!customer) {
    return (
  ...
  return (
    <aside className="cm-detail">
      ...
      <section className="cm-timeline-placeholder">
        <h3>고객별 업무기록</h3>
        <p>현재 단계에서는 표시만 준비했습니다. 다음 단계에서 상담·방문·매물 기록과 연결됩니다.</p>
      </section>
    </aside>
  )
}
...
export default function CustomerManager() {
  ...
  }, [categoryFilter, debouncedSearch, managerFilter, roleFilter, sortMode, statusFilter])
  ...
  return (
    <div className="cm-app">
      ...
      <main className="cm-main">
        ...
        <CustomerDetail customer={selectedCustomer} onEdit={startEdit} />
      </main>
    </div>
  )
}
